...
- Niche repo guardrails, publishing notes, tool schema rules, session-log rules: `.ai/rules/reference.md`

## Loading Rule

Do not load unrelated rule files just because they exist. Keep active context narrow.
