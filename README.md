...
- 已完成的 TODO 主要集中在两条线：`Desktop MVP Slim` 的安全与鉴权闭环，以及 `Project Neuro` 的 P0 基础能力（P0-001 到 P0-003）。
- 当前 Neuro 下一优先级为 `TODO-P0-005`：gateway ingest endpoint + validation + per-session volatile snapshot cache。
